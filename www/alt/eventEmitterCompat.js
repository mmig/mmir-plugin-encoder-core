...
/*
 * compatiblity wrapper for use in older mmir-lib versions which did not include mmirf/events
 * NOTE: copied from mmir-lib (v7.x) /lib/tools/eventEmitter.js
 */
 ...
 * 															NOTE: should not be used in combination with {@link #createEventHandlerProperty}
 * @constructor
 * @memberOf mmir.tools
 */
